package com.web.ddentist.hospital.crm.sms.util;
...
public class SmsSendUtil {
	...
	public String parseSmsContent(String smsContent, String ptNm, String nxResvDt) {

		smsContent = smsContent.replace("$고객명$", ptNm);
		String resvDt = "-";
		if(nxResvDt != null && !nxResvDt.equals("")) {

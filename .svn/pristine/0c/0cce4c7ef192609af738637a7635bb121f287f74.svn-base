...
<section class="container">
	...
	<div style="width: 85%; margin-left: 15%; margin-top: 50px;">
		...
		<div style="width: 900px; height: 120px; background-color: #3D3D3D; padding: 20px;">
			...
			<button class="btn btn-primary violetBtn btn-lg" type="button" id="findWayBtn" style="width: 120px; height: 80px; float: right;" onclick="btnClick()">
...
<script>
	function btnClick() {
		window.open("https://map.kakao.com/link/map/대덕인재개발원,36.325059279000115,127.40891523554417");
	}
</script>
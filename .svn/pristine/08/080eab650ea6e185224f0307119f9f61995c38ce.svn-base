...
<body>
	...
	<section class="container">
	    <div style="margin-left:7%; margin-top:13%; width:85%; margin-bottom: 100px;">
	        <div class="cardbody">
	            <h4 style="font-family: 'Noto Sans KR', sans-serif; font-weight:700;">아이디찾기</h4>
	            <hr style="width:100%; height:2px; background:#FF5252; opacity:1; margin-bottom: 50px;"/>
	            <form style="padding-left:7%;" name="findIdForm" action="/ddit/findId" method="post">
	                <div class="row mb-3" style="padding-bottom:30px;">
	                    <label for="ptNm" class="col-sm-2 col-form-label"><span style="color:red;">*</span>이름</label>
	                    <div class="col-sm-6">
	                ...
	                <div class="row mb-3" style="padding-bottom:30px;">
	                    ...
	                    <div class="col-sm-3">
	                        <input type="button" value="인증번호 받기" id="sendAuthNum" class="btn btn-primary violetBtn certificationBtn" />
	                    </div>
	                </div>
	                <!-- 인증번호 확인 -->
	                ...
	                <div class="row">
	                    <div class="col-2"></div>
	                    <sec:csrfInput />
	                    <button type="submit" id="findIdBtn" class="col-3 btn btn-primary violetBtn btn-lg chkBtn" disabled>확인</button>
...
$("#sendAuthNum").on("click",function(){
	...
	const ptPhone = findIdForm.ptPhone1.value + findIdForm.ptPhone2.value + findIdForm.ptPhone3.value;

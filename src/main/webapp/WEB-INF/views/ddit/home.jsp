    ...
    <div class="row">
        ...
        <div class="col-md-3" style="padding:0px; margin:0px;">
            <div style="margin-top:10px; margin-left:15px; width:100%; height:528px; border:3px solid #0035413f; border-radius: 50px;">
                ...
                <div class="swiper mySwiper2" style="height: 390px; border-radius: 50px;">
                            		...
                            		<div style="margin-top: 2%;text-align: center;">
										<c:choose>
											<c:when test="${list.thumbnail==null}">
												<img src="/resources/images/employee/s_cb8450a3-35e9-44e1-9598-730c60f5cb54_user.png" style="height:150px; width:150px; margin-bottom:4%;  border-radius: 50%;" >										
											</c:when>
											<c:otherwise>
												<img src="${list.thumbnail}" style="height:200px; width:150px; margin-bottom:4%; border-radius: 50%;" >								
											</c:otherwise>
										</c:choose>
                    ...
                    <div class="swiper-button-next" style="margin:150px 70px; color:#808080;"></div>
                    <div class="swiper-button-prev" style="margin:150px 70px; color:#808080;"></div>
                    <div class="swiper-pagination"></div>
                </div>
            </div>
        </div>

...
public interface IBoardService {
	 ...
	 * @return 성공 여부와 공지사항 게시글 번호가 담긴 Map 객체 (성공 여부 : "result", 게시글 번호 : "noNum")<br>
	 * 		   성공 : "INSERT", 실패 : "FAILED"
	 */
	public Map<String, String> insertNotice(NoticeVO noVO);
	
	/**
	 * 공지사항 수정
	 * 
	 * @param noVO 수정할 공지사항 번호, 공지사항 제목, 공지사항 내용
	 * @return 성공 여부가 담긴 Map 객체 (성공 여부 : "result")<br>
	 * 		   성공 : "UPDATE", 실패 : "FAILED"
	 */
	public Map<String, String> updateNotice(NoticeVO noVO);

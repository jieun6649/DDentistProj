...
public class PreservationController {
	...
	@GetMapping("/list")
	public String list() {
		Object ptDetails = presvService.getPatientDetails();
		if(!ptDetails.equals("anonymousUser")) return "redirect:/ddit/resv/listPresv";
	...
	@PreAuthorize("hasRole('ROLE_PT')")
	@GetMapping("/listPresv")
	public String listPresv(Model model) {
		PatientDetails ptDetails = (PatientDetails) presvService.getPatientDetails();
		List<ReservationVO> presvList = presvService.listPresv(ptDetails);

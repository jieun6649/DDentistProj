...
public interface ChartMapper {
	...
	/**
	 * 진료 건에 대한 수납 정보를 추가한다.
	 *
	 * @param chkVO 진료 번호와 총 진료비가 담긴 VO
	 * @return 성공 : 1, 실패 : 0
	 */
	public int insertRcvmt(CheckupVO chkVO);
...
//	public List<TxNextVO> listPtTxNext(String ptNum);
	...
	/**
	 * 환자의 Medical Alerts 조회
	 *
	 * @param ptNum 환자 번호
	 * @return 환자의 문진표와 기저 질환 목록이 담긴 VO
	 */
	 ...
	 * 특정 치아의 처치 기록을 가져옴
	 *
	 * @param searchMap 처치 기록을 조회할 환자 번호, 치아 번호
	 * @return 해당 환자의 치아에 대한 처치 기록 목록
	 */
